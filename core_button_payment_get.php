    ...
    <div class="col-12">
        <div class="card card-border-info">
            <div class="card-body">
                ...
                <span class="float-right"><a href="core_button_payment_create.php" class="btn btn-success btn-sm">Nuevo Botón <i class="pe-7s-add-user"></i></a></span><br><br>
...
<script>
    ...
    function gettbButtonPyament() {
        ...
        $.ajax({
            ...
            data: "action=gettbButtonPyament",
            success: function (text) {
                ...
                txt += '<thead class="table-primary text-light"><tr><th>#</th><th>Acción</th> <th>Botón</th> <th>Descripción</th> <th>Comentarios </th> </tr></thead>';
                for (x in date) {

                    var a = parseInt(x);
                    var estatus = date[x].suspended;
                    var idibutton = date[x].idibutton;
                    var suspended = date[x].suspended;
                    var btn_update = '<a href= "core_button_payment_update.php?idibutton=' + idibutton + '" type="button" class="btn btn-sm">Editar <i class="fa fa-pen-square"></i></a>';
