            ...
            success: function (text) {
                ...
                for (x in date) {
                    ...
                    if (date[x].facturado == 'No') {
                        ...
                        txt += "<td><button type='button' title='Descargar Factura' class='btn btn-sm btn-secondary docs' folio='" + date[x].folio_facturado + "' serie='' matricula='" + date[x].matricula + "' data-toggle='modal' data-target='#documento' id='btndownloadDocs'><i class='fas fa-download'></i></button></td>";
                    }
