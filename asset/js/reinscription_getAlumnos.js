    ...
    $.ajax({
        ...
        success: function (text) {
            ...
            txt += '<div class="table-responsive">'
                    ...
                    + ' <thead class="table-primary text-light"> <tr><th>#</th><th>Matricula</th><th>Nombre</th><th>Apellido Paterno</th><th>Apellido Materno</th><th>Carrera</th><th>Turno</th><th>Cuatrimestre</th><th>Beca</th><th>Categoria</th><th>Archivo</th><th>Generales</th> </tr> </thead><tbody>';
            for (x in date) {
            ...
            $('#sumab tbody').on('click', 'tr', function () {
                ...
                //$("#idiarchivo").val(datos[10]);
                $("#idigenerales").val(datos[11]);
...
var sumarb = function () {
    ...
    $('#sumab tbody').on('click', 'tr', function () {
        ...
        $("#promovido").val(promovido);
        $("#idicarrera").val(datos.idicarrera);
        
        $("#idigenerales").val(datos.idigenerales);
        $("#promovido").attr({
            "max": promovido, // substitute your own
            "min": cuatrimestre          // values (or variables) here
        });
