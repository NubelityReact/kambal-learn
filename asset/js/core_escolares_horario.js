...
function getNivel() {
    ...
    $.ajax({
        ...
        success: function (text) {
            ...
            for (x in date) {
                txt += '<option value="' + date[x].NivelId + '">ID Nivel: ' + date[x].NivelId + ', ' + date[x].Descripcion + '</option>';
            }
            txt += "</select>";
            $("#divNivel").html(txt);
        }
...
function divTurno() {
    ...
    $.ajax({
        ...
        success: function (text) {
            ...
            txt += '<option value="">Seleccione</option>';
            for (x in date) {
                txt += '<option value="' + date[x].TurnoId + '">ID Turno: ' + date[x].TurnoId + ', ' + date[x].Descripcion + '</option>';
            }
            txt += "</select>";
            $("#divTurno").html(txt);
        }
