                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" id="idiciclo" name="idiciclo" placeholder="Enter idiciclo"  onchange="setAbrev()">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="abrev" name="abrev" placeholder="Enter abrev" required readonly="true">
                                    <div class="help-block with-errors text-danger"></div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="estatus" name="estatus" placeholder="Enter estatus" required>
...
<script>
    function setAbrev() {
        ...
        var year = $("#year").val();
        var str1 = turnoId.substr(0, 1);
        var abrev1 = str1.replace("-", "");
        $('#abrev').val(year + '-' + Periodo);
        $('#ciclo').val(year + '-' + Periodo + '' + turnoId.substr(0, 1));
    }
</script>
<script>
