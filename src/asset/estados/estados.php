...
if (isset($_GET["estados"])) {
    ...
    $country = $_GET["estados"];

    // Define country and city array     
    $countryArr = array(
        "Mexico" => array("Selecciona tu estado", "Aguascalientes", "Baja California", "Baja
California Sur", "Campeche", "Chiapas", "Chihuahua", "Coahuila", "Colima", "CDMX", "Durango", "México", "Guanajuato", "Guerrero", "Hidalgo", "Jalisco", "Michoacán", "Morelos", "Nayarit", "Nuevo León", "Oaxaca", "Puebla", "Querétaro", "Quintana Roo", "San
...
if (isset($_GET["municipios"])) {
    ...
    $municipiosARR = array(
        ...
        "Durango" => array("Selecciona tu municipio",
            ...
            "Nuevo Ideal",
            "Pánuco de Coronado"),
        "CDMX" => array("Selecciona tu municipio",
            "álvaro Obregón",
            "Azcapotzalco",
            "Benito Juárez",
            "Coyoacán",
