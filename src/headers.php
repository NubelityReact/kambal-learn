                ...
                <nav class="navbar header-navbar pcoded-header">
                    <div class="navbar-wrapper">
                        ...
                        <div class="navbar-logo">
                            ...
                            <a href="menu.php" id="btnlogo" style="width:100%; height:120%">
                                <img class="img-fluid" src="asset/images/logo/<?php echo $frontpageimage; ?>"  alt="<?php echo $shortname; ?>" style="height:100%"/>
                            </a>
