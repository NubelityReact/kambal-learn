                ...
                <div class="col-sm-4">
                    <center> 
                        ...
                        <div class="contact-icon">
                            ...
                            <a href="credencialProfesor.php?idiprofesor=<?php echo $_GET['idiprofesor'] ?>" target="_blank"><button class="btn btn-default" data-placement="bottom" title="Imprimir Credencial" id="printTar"><i class="pe-7s-print m-0"></i></button></a>
                        </div>
                    </center>
                </div>
...
<script>
                                    ...
                                    function submitFormImage() {
                                        ...
                                        var idi = "<?php echo $_GET['idiprofesor']; ?>";
                                        //alert('data ' + dataString);
                                        $.ajax({
                                            type: "POST",
                                            url: "dataConect/API.php",
                                            //data: "name=" + name + "&email=" + email + "&message=" + message,
                                            data: "action=updateImageProfesorById&idiprofesor=" + idi + "&" + dataString,
...
<script>
                                    ...
                                    angular.module('MyFirstApp', [])
                                            .controller("FirstController", function ($scope, $http)
                                            {
                                                ...
                                                $http.get("dataConect/API.php?action=getDatosProfesorbyId&idiprofesor=" + idiprofesor)
